...
ActiveRecord::Schema.define(version: 2020_08_13_043430) do
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.datetime "end_time"
    t.string "title"
    t.boolean "poster_has_reviewed", default: false
    t.boolean "respondent_has_reviewed", default: false
    t.string "address"
    t.float "latitude"
    t.float "longitude"
    t.string "country"
  ...
  create_table "appt_locations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["appointment_id"], name: "index_appt_locations_on_appointment_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.bigint "reputation", default: 3, null: false
